            ...
            <div className='grid grid-cols-1 lg:grid-cols-5 gap-5 container mx-auto
             bg-gray-100 p-10'>
                <div className='grid col-span-4'>
                    <h2 className='text-2xl text-black font-semibold p-3'>Customer Tickets</h2>
                ...
                <div className=''>
                    <h2 className='text-2xl text-black font-semibold p-3'>Task Status</h2>
                    <div>
                        {
                    ...
                    <div>
                    <h2 className='text-2xl font-semibold text-black p-3'>Resolved Task</h2>
                    <div>
                        {
